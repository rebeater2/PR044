	soc_system u0 (
		...
		.clk_for_data_export                   (<connected-to-clk_for_data_export>),                   // clk_for_data.export
		...
		.sound1_io_export                      (<connected-to-sound1_io_export>),                      //    sound1_io.export
		.sound2_io_export                      (<connected-to-sound2_io_export>),                      //    sound2_io.export
		.sound3_pio_export                     (<connected-to-sound3_pio_export>),                     //   sound3_pio.export
		.sound4_pio_export                     (<connected-to-sound4_pio_export>),                     //   sound4_pio.export
		.sound5_pio_export                     (<connected-to-sound5_pio_export>),                     //   sound5_pio.export
		.sound6_pio_export                     (<connected-to-sound6_pio_export>),                     //   sound6_pio.export
		.switch_pio_export                     (<connected-to-switch_pio_export>),                     //   switch_pio.export
		.x_export                              (<connected-to-x_export>),                              //            x.export
		.y_export                              (<connected-to-y_export>)                               //            y.export
	);
