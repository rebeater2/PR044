...
/*
 * Macros for device 'sound6_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SOUND6_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SOUND6_PIO_COMPONENT_TYPE altera_avalon_pio
#define SOUND6_PIO_COMPONENT_NAME sound6_pio
#define SOUND6_PIO_BASE 0xff200000
#define SOUND6_PIO_SPAN 16
#define SOUND6_PIO_END 0xff20000f
#define SOUND6_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SOUND6_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SOUND6_PIO_CAPTURE 0
#define SOUND6_PIO_DATA_WIDTH 16
#define SOUND6_PIO_DO_TEST_BENCH_WIRING 0
#define SOUND6_PIO_DRIVEN_SIM_VALUE 0
#define SOUND6_PIO_EDGE_TYPE NONE
#define SOUND6_PIO_FREQ 50000000
#define SOUND6_PIO_HAS_IN 1
#define SOUND6_PIO_HAS_OUT 0
#define SOUND6_PIO_HAS_TRI 0
#define SOUND6_PIO_IRQ_TYPE NONE
#define SOUND6_PIO_RESET_VALUE 0

/*
 * Macros for device 'l_y', class 'altera_avalon_pio'
 * The macros are prefixed with 'L_Y_'.
 * The prefix is the slave descriptor.
 */
#define L_Y_COMPONENT_TYPE altera_avalon_pio
#define L_Y_COMPONENT_NAME l_y
#define L_Y_BASE 0xff200010
#define L_Y_SPAN 16
#define L_Y_END 0xff20001f
#define L_Y_BIT_CLEARING_EDGE_REGISTER 0
#define L_Y_BIT_MODIFYING_OUTPUT_REGISTER 0
#define L_Y_CAPTURE 0
#define L_Y_DATA_WIDTH 9
#define L_Y_DO_TEST_BENCH_WIRING 0
#define L_Y_DRIVEN_SIM_VALUE 0
#define L_Y_EDGE_TYPE NONE
#define L_Y_FREQ 50000000
#define L_Y_HAS_IN 0
#define L_Y_HAS_OUT 1
#define L_Y_HAS_TRI 0
#define L_Y_IRQ_TYPE NONE
#define L_Y_RESET_VALUE 0

/*
 * Macros for device 'l_x', class 'altera_avalon_pio'
 * The macros are prefixed with 'L_X_'.
 * The prefix is the slave descriptor.
 */
#define L_X_COMPONENT_TYPE altera_avalon_pio
#define L_X_COMPONENT_NAME l_x
#define L_X_BASE 0xff200020
#define L_X_SPAN 16
#define L_X_END 0xff20002f
#define L_X_BIT_CLEARING_EDGE_REGISTER 0
#define L_X_BIT_MODIFYING_OUTPUT_REGISTER 0
#define L_X_CAPTURE 0
#define L_X_DATA_WIDTH 10
#define L_X_DO_TEST_BENCH_WIRING 0
#define L_X_DRIVEN_SIM_VALUE 0
#define L_X_EDGE_TYPE NONE
#define L_X_FREQ 50000000
#define L_X_HAS_IN 0
#define L_X_HAS_OUT 1
#define L_X_HAS_TRI 0
#define L_X_IRQ_TYPE NONE
#define L_X_RESET_VALUE 0

/*
 * Macros for device 'clk_for_data', class 'altera_avalon_pio'
 * The macros are prefixed with 'CLK_FOR_DATA_'.
 * The prefix is the slave descriptor.
 */
#define CLK_FOR_DATA_COMPONENT_TYPE altera_avalon_pio
#define CLK_FOR_DATA_COMPONENT_NAME clk_for_data
#define CLK_FOR_DATA_BASE 0xff200030
#define CLK_FOR_DATA_SPAN 16
#define CLK_FOR_DATA_END 0xff20003f
#define CLK_FOR_DATA_BIT_CLEARING_EDGE_REGISTER 0
#define CLK_FOR_DATA_BIT_MODIFYING_OUTPUT_REGISTER 0
#define CLK_FOR_DATA_CAPTURE 0
#define CLK_FOR_DATA_DATA_WIDTH 1
#define CLK_FOR_DATA_DO_TEST_BENCH_WIRING 0
#define CLK_FOR_DATA_DRIVEN_SIM_VALUE 0
#define CLK_FOR_DATA_EDGE_TYPE NONE
#define CLK_FOR_DATA_FREQ 50000000
#define CLK_FOR_DATA_HAS_IN 1
#define CLK_FOR_DATA_HAS_OUT 0
#define CLK_FOR_DATA_HAS_TRI 0
#define CLK_FOR_DATA_IRQ_TYPE NONE
#define CLK_FOR_DATA_RESET_VALUE 0

/*
 * Macros for device 'sound5_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SOUND5_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SOUND5_PIO_COMPONENT_TYPE altera_avalon_pio
#define SOUND5_PIO_COMPONENT_NAME sound5_pio
#define SOUND5_PIO_BASE 0xff200040
#define SOUND5_PIO_SPAN 16
#define SOUND5_PIO_END 0xff20004f
#define SOUND5_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SOUND5_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SOUND5_PIO_CAPTURE 0
#define SOUND5_PIO_DATA_WIDTH 16
#define SOUND5_PIO_DO_TEST_BENCH_WIRING 0
#define SOUND5_PIO_DRIVEN_SIM_VALUE 0
#define SOUND5_PIO_EDGE_TYPE NONE
#define SOUND5_PIO_FREQ 50000000
#define SOUND5_PIO_HAS_IN 1
#define SOUND5_PIO_HAS_OUT 0
#define SOUND5_PIO_HAS_TRI 0
#define SOUND5_PIO_IRQ_TYPE NONE
#define SOUND5_PIO_RESET_VALUE 0

/*
 * Macros for device 'sound4_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SOUND4_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SOUND4_PIO_COMPONENT_TYPE altera_avalon_pio
#define SOUND4_PIO_COMPONENT_NAME sound4_pio
#define SOUND4_PIO_BASE 0xff200050
#define SOUND4_PIO_SPAN 16
#define SOUND4_PIO_END 0xff20005f
#define SOUND4_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SOUND4_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SOUND4_PIO_CAPTURE 0
#define SOUND4_PIO_DATA_WIDTH 16
#define SOUND4_PIO_DO_TEST_BENCH_WIRING 0
#define SOUND4_PIO_DRIVEN_SIM_VALUE 0
#define SOUND4_PIO_EDGE_TYPE NONE
#define SOUND4_PIO_FREQ 50000000
#define SOUND4_PIO_HAS_IN 1
#define SOUND4_PIO_HAS_OUT 0
#define SOUND4_PIO_HAS_TRI 0
#define SOUND4_PIO_IRQ_TYPE NONE
#define SOUND4_PIO_RESET_VALUE 0

/*
 * Macros for device 'sound3_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SOUND3_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SOUND3_PIO_COMPONENT_TYPE altera_avalon_pio
#define SOUND3_PIO_COMPONENT_NAME sound3_pio
#define SOUND3_PIO_BASE 0xff200060
#define SOUND3_PIO_SPAN 16
#define SOUND3_PIO_END 0xff20006f
#define SOUND3_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SOUND3_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SOUND3_PIO_CAPTURE 0
#define SOUND3_PIO_DATA_WIDTH 16
#define SOUND3_PIO_DO_TEST_BENCH_WIRING 0
#define SOUND3_PIO_DRIVEN_SIM_VALUE 0
#define SOUND3_PIO_EDGE_TYPE NONE
#define SOUND3_PIO_FREQ 50000000
#define SOUND3_PIO_HAS_IN 1
#define SOUND3_PIO_HAS_OUT 0
#define SOUND3_PIO_HAS_TRI 0
#define SOUND3_PIO_IRQ_TYPE NONE
#define SOUND3_PIO_RESET_VALUE 0

/*
 * Macros for device 'sound2_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SOUND2_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SOUND2_PIO_COMPONENT_TYPE altera_avalon_pio
#define SOUND2_PIO_COMPONENT_NAME sound2_pio
#define SOUND2_PIO_BASE 0xff200070
#define SOUND2_PIO_SPAN 16
#define SOUND2_PIO_END 0xff20007f
#define SOUND2_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SOUND2_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SOUND2_PIO_CAPTURE 0
#define SOUND2_PIO_DATA_WIDTH 16
#define SOUND2_PIO_DO_TEST_BENCH_WIRING 0
#define SOUND2_PIO_DRIVEN_SIM_VALUE 0
#define SOUND2_PIO_EDGE_TYPE NONE
#define SOUND2_PIO_FREQ 50000000
#define SOUND2_PIO_HAS_IN 1
#define SOUND2_PIO_HAS_OUT 0
#define SOUND2_PIO_HAS_TRI 0
#define SOUND2_PIO_IRQ_TYPE NONE
#define SOUND2_PIO_RESET_VALUE 0

/*
 * Macros for device 'sound1_pio', class 'altera_avalon_pio'
 * The macros are prefixed with 'SOUND1_PIO_'.
 * The prefix is the slave descriptor.
 */
#define SOUND1_PIO_COMPONENT_TYPE altera_avalon_pio
#define SOUND1_PIO_COMPONENT_NAME sound1_pio
#define SOUND1_PIO_BASE 0xff200080
#define SOUND1_PIO_SPAN 16
#define SOUND1_PIO_END 0xff20008f
#define SOUND1_PIO_BIT_CLEARING_EDGE_REGISTER 0
#define SOUND1_PIO_BIT_MODIFYING_OUTPUT_REGISTER 0
#define SOUND1_PIO_CAPTURE 0
#define SOUND1_PIO_DATA_WIDTH 16
#define SOUND1_PIO_DO_TEST_BENCH_WIRING 0
#define SOUND1_PIO_DRIVEN_SIM_VALUE 0
#define SOUND1_PIO_EDGE_TYPE NONE
#define SOUND1_PIO_FREQ 50000000
#define SOUND1_PIO_HAS_IN 1
#define SOUND1_PIO_HAS_OUT 0
#define SOUND1_PIO_HAS_TRI 0
#define SOUND1_PIO_IRQ_TYPE NONE
#define SOUND1_PIO_RESET_VALUE 0
...
#define SWITCH_PIO_BASE 0xff200090
#define SWITCH_PIO_SPAN 16
#define SWITCH_PIO_END 0xff20009f
...
#define BUTTON_PIO_BASE 0xff2000a0
#define BUTTON_PIO_SPAN 16
#define BUTTON_PIO_END 0xff2000af
...
#define LED_PIO_BASE 0xff2000b0
#define LED_PIO_SPAN 16
#define LED_PIO_END 0xff2000bf
...
#define SYSTEM_ID_BASE 0xff2000c0
#define SYSTEM_ID_SPAN 8
#define SYSTEM_ID_END 0xff2000c7
#define SYSTEM_ID_ID 3725647376
#define SYSTEM_ID_TIMESTAMP 1527939431
